# Vue CMS with Strapi/MySQL

Vue starter for creating a site with Strapi/MySQL as the CMS.

It is fully customizable and due to the fact that it is open source, fully open to contributions. Do not hesitate to add new features etc ...
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=reponame)
