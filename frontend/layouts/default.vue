        ...
        <div class="uk-modal-dialog">
            ...
            <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                ...
                <div class="uk-padding-large">
                    <h1 style="font-family: Staatliches;">Nuxt Vue Graphql CMS</h1>
                    ...
                    <p class="uk-text-light">Built with Vue JS, Apollo, Strapi, UIKit and a few other goodies</p>
                </div>
            </div>
        </div>
    </div>
